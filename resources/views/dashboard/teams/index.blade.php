...
<div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <div class="input-group input-group-sm" style="width: 150px;">
                    <a href="/soccer/public/dashboard/teams/create" class="btn btn-sm btn-info float-left">Create New Team</a>
            </div>
          </div>
        </div>
        <!-- /.card-header -->
          ...
          <table class="table table-hover text-nowrap">
            ...
            @foreach($data['teams'] as $team)
              <tr>
                ...
                <td>
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                      <a href="/soccer/public/dashboard/players/create/{{$team->id}}" class="btn btn-sm btn-primary float-left">Add New Player</a>
                    </div>
                </td>
                <td>
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                      <a href="/soccer/public/dashboard/players/team/{{$team->id}}" class="btn btn-sm btn-info float-left">View All Players</a>
                    </div>
                </td>
                <td>
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <a href="/soccer/public/dashboard/teams/{{$team->id}}" class="btn btn-sm btn btn-secondary float-left">Details</a>
                    </div>
                </td>
                <td>
                  <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                  <a href="/soccer/public/dashboard/players/all/{{$team->id}}" class="btn btn-block btn-success btn-sm">Add Existing Player</a>
                  </div>
                </td>
                <td>
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                      <a href="/soccer/public/dashboard/teams/{{$team->id}}/edit" class="btn btn-sm btn-warning float-left">Edit</a>
                    </div>
                </td>
                <td>
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        @else
            <div class="card-body table-responsive p-0">
                <p align="center" >You have no Teams</p>
            </div>
        <!-- /.card-body -->
        @endif
      </div>
