                  ...
                  {!! Form::open(['action' => 'TeamController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        {{Form::text('team_gender', '', ['class' => 'form-control', 'placeholder' => 'Team Gender'])}}
                        </div>
                        <div class="form-group">
                            {{Form::label('team_leader_name', 'Team Leader Name')}}
                            {{Form::text('team_leader_name', '', ['class' => 'form-control', 'placeholder' => 'Team Leader'])}}
                            </div>
                        <div class="form-group">
                            {{Form::label('team_leader_decription', 'Team Leader Description')}}
                            {{Form::textarea('team_leader_decription', '', ['id' => 'article-ckeditor', 'class' => 'form-control', 'placeholder' => 'Write Something About Your Self'])}}
                      </div>
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            {{Form::file('team_pic')}}
                            <label class="custom-file-label" for="team_pic">Choose file</label>
                          </div>
